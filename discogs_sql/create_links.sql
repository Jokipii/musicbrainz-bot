...
ALTER TABLE mb_artist_link ADD CONSTRAINT mb_artist_link_pkey PRIMARY KEY (gid, url);
...
ALTER TABLE mb_label_link ADD CONSTRAINT mb_label_link_pkey PRIMARY KEY (gid, url);
ALTER TABLE mb_label_link ADD CONSTRAINT mb_label_link_fk_label FOREIGN KEY (id) REFERENCES label(id);
